		...
		"aoColumns" : [ {
			...
			"mDataProp" : "title",
	            "fnRender": function (oObj) {
		           	return "<td>" + oObj.aData.title + "</td><br>" + "<td>" + oObj.aData.identityId + "</td>";
      	   }
		}, {
			...
			"mDataProp" : "twoDimension",
	            "fnRender": function (oObj) {
	           	 	return '<img src="'+"/upload/" + oObj.aData.isbn + "/" + oObj.aData.twoDimension + '" width="60" onmouseover="width=240;height=180;" onmouseout="this.width=60;"/>';
       	   }
		}, {
			"sTitle" : "操作",
			"mData" : null,
			...
			"fnRender" : function(oObj) {
				...
				var end = '</div>';
				return start + edit + trash + splitXML + viewElement + end; 
			}
		} ],
