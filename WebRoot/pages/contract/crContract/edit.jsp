					...
					<form:form id="contractForm" commandName="form" class="form-horizontal">
						...
						<div class="row-fluid">
							<div id="contractMaxAmountDiv" class="control-group span6">
								...
								<div class="controls">
	                 				<form:input path="crContract.contractMaxAmount" id="contractMaxAmount" placeholder="合同最多金额" onblur="Editorial.Contract.validateContractMaxAmount();"/>
							...
							<div id="contractMinAmountDiv" class="control-group span6">
								...
								<div class="controls">
	                 				<form:input path="crContract.contractMinAmount" id="contractMinAmount" placeholder="合同最少金额" onblur="Editorial.Contract.validateContractMinAmount();"/>
