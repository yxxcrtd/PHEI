	...
	Editorial.Contract.oTable1 = $('#table_report').dataTable({
        ...
        "aoColumns": 
        	[ { 
    			...
    			"sTitle": " 合同过期天数",
				"mDataProp": "contractDays"
			}, {
    			"sTitle": "合同License时间",
    			"mDataProp":"contractLicenseDuration"
			},{
    			"sTitle": "合同License开始日期",
    			...
    			"sTitle": "合同License开始选项",
				"mDataProp": "contractLicenseOption"
			}, {
    			"sTitle": "合同作者获取免费样书个数",
    			"mDataProp":"contractAuthorCount"
			},{
    			"sTitle": "合同代理商获取免费样书个数",
